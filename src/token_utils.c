...
/* faz um print na funcao organize env, e verifica ate onde(na direcao contraria) e que o valor nao muda, e onde deveria mudar(verifica no segundo analise, refine) */
